...
> 173 components exported from carbon-components-svelte@0.98.2.
...
| title           | No       | <code>let</code> | No       | <code>string</code>  | <code>"title"</code>           | Specify the title of the accordion item heading.<br />Alternatively, use the "title" slot.<br />@example `svelte <br /><br />&lt;AccordionItem&gt;<br />  &lt;div slot="title"&gt;Custom Title&lt;/div&gt;<br />&lt;/AccordionItem&gt;<br />` |
...
| icon             | No       | <code>let</code> | No       | <code>any</code>                                                                                                                          | <code>undefined</code> | Specify the icon to render.<br />Alternatively, use the named slot "icon".<br />@example `svelte <br /><br />&lt;Button&gt;<br />  &lt;Icon slot="icon" size={20} /&gt;<br />&lt;/Button&gt;<br />`                                                       |
...
| as               | No       | <code>let</code> | No       | <code>boolean</code>                                                                                                                      | <code>false</code>     | Set to `true` to render a custom HTML element.<br />Props are destructured as `props` in the default slot.<br />@example `svelte <br /><br />&lt;Button let:props&gt;<br />  &lt;div {...props}&gt;Custom Element&lt;/div&gt;<br />&lt;/Button&gt;<br />` |
| skeleton         | No       | <code>let</code> | No       | <code>boolean</code>                                                                                                                      | <code>false</code>     | Set to `true` to display the skeleton state                                                                                                                                                                                                               |
...
| code                  | No       | <code>let</code> | No       | <code>string</code>                                  | <code>undefined</code>                             | Set the code snippet text.<br />Alternatively, use the default slot.<br /><br />NOTE: you _must_ use the `code` prop for the copy-to-clipboard functionality.<br />@example `svelte <br /><br />&lt;CodeSnippet&gt;{code}&lt;/CodeSnippet&gt;<br />` |
...
| Prop name     | Required | Kind             | Reactive | Type                                                                                               | Default value          | Description                                                                                                                                                                                                                                                |
| :------------ | :------- | :--------------- | :------- | -------------------------------------------------------------------------------------------------- | ---------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| as            | No       | <code>let</code> | No       | <code>boolean</code>                                                                               | <code>false</code>     | Set to `true` to render a custom HTML element.<br />Props are destructured as `props` in the default slot.<br />@example `svelte <br /><br />&lt;Column let:props&gt;<br />  &lt;article {...props}&gt;Content&lt;/article&gt;<br />&lt;/Column&gt;<br />` |
...
| translateWithIdSelection | No       | <code>let</code>      | No       | <code>(id: "clearSelection") => string</code>                                                         | <code>undefined</code>                             | Override the label of the clear button when the input has a selection.<br />Defaults to "Clear selected item" since a combo box can only have one selection.                                                                                                                                                                                                                                                                         |
...
| clear                    | No       | <code>function</code> | No       | <code>(options?: { focus?: boolean; }) => Promise<void></code>                                        | --                                                 | Clear the combo box programmatically.<br />By default, focuses the combo box after clearing. Set `options.focus` to `false` to prevent focusing.<br />@example `svelte <br /><br />&lt;ComboBox bind:this={comboBox} items={items} /&gt;<br />&lt;button on:click={() =&gt; comboBox.clear()}&gt;Clear&lt;/button&gt;<br />&lt;button on:click={() =&gt; comboBox.clear({ focus: false })}&gt;Clear (No Focus)&lt;/button&gt;<br />` |
...
| labelText    | No       | <code>let</code> | No       | <code>string</code>                    | <code>""</code>                                    | Specify the label text.<br />Alternatively, use the "labelChildren" slot.<br />@example `svelte <br /><br />&lt;ContextMenuOption&gt;<br />  &lt;span slot="labelChildren"&gt;Custom Label&lt;/span&gt;<br />&lt;/ContextMenuOption&gt;<br />` |
| shortcutText | No       | <code>let</code> | No       | <code>string</code>                    | <code>""</code>                                    | Specify the shortcut text.<br />Alternatively, use the "shortcutText" slot.<br />@example `svelte <br /><br />&lt;ContextMenuOption&gt;<br />  &lt;span slot="shortcutText"&gt;Ctrl+K&lt;/span&gt;<br />&lt;/ContextMenuOption&gt;<br />`      |
...
| maxFileSize      | No       | <code>let</code>   | No       | <code>number &#124; undefined</code>                               | <code>undefined</code>                  | Specify the maximum file size in bytes.<br />Files exceeding this limit will be filtered out.<br />File sizes use binary (base 2) units: 1024 bytes = 1 KiB, not 1000 bytes.<br />@example `svelte <br /><br />&lt;!-- 5 MB = 5 × 1024 × 1024 = 5,242,880 bytes --&gt;<br />&lt;FileUploader maxFileSize={5 * 1024 * 1024} /&gt;<br />` |
| multiple         | No       | <code>let</code>   | No       | <code>boolean</code>                                               | <code>false</code>                      | Set to `true` to allow multiple files                                                                                                                                                                                                                                                                                                   |
| clearFiles       | No       | <code>const</code> | No       | <code>() => void</code>                                            | --                                      | Programmatically clear the uploaded files.<br />@example `svelte <br /><br />&lt;FileUploader bind:this={uploader} bind:files={files} /&gt;<br />&lt;button on:click={() =&gt; uploader.clearFiles()}&gt;Clear Files&lt;/button&gt;<br />`                                                                                              |
| labelTitle       | No       | <code>let</code>   | No       | <code>string</code>                                                | <code>""</code>                         | Specify the label title.<br />Alternatively, use the named slot "labelTitle".<br />@example `svelte <br /><br />&lt;FileUploader&gt;<br />  &lt;span slot="labelTitle"&gt;Custom Label&lt;/span&gt;<br />&lt;/FileUploader&gt;<br />`                                                                                                   |
| labelDescription | No       | <code>let</code>   | No       | <code>string</code>                                                | <code>""</code>                         | Specify the label description.<br />Alternatively, use the named slot "labelDescription".<br />@example `svelte <br /><br />&lt;FileUploader&gt;<br />  &lt;span slot="labelDescription"&gt;Custom description text&lt;/span&gt;<br />&lt;/FileUploader&gt;<br />`                                                                      |
...
| Prop name     | Required | Kind             | Reactive | Type                 | Default value      | Description                                                                                                                                                                                                                                          |
| :------------ | :------- | :--------------- | :------- | -------------------- | ------------------ | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| as            | No       | <code>let</code> | No       | <code>boolean</code> | <code>false</code> | Set to `true` to render a custom HTML element.<br />Props are destructured as `props` in the default slot.<br />@example `svelte <br /><br />&lt;Grid let:props&gt;<br />  &lt;header {...props}&gt;Content&lt;/header&gt;<br />&lt;/Grid&gt;<br />` |
...
| companyName             | No       | <code>let</code> | No       | <code>string</code>                        | <code>undefined</code> | Specify the company name.<br /><br />Alternatively, use the named slot "company".<br />@example `svelte <br /><br />&lt;Header&gt;<br />  &lt;span slot="company"&gt;IBM&lt;/span&gt;<br />&lt;/Header&gt;<br />`                                                            |
| platformName            | No       | <code>let</code> | No       | <code>string</code>                        | <code>""</code>        | Specify the platform name.<br />Alternatively, use the named slot "platform".<br />@example `svelte <br /><br />&lt;Header&gt;<br />  &lt;span slot="platform"&gt;Platform Name&lt;/span&gt;<br />&lt;/Header&gt;<br />`                                                     |
...
| text                       | No       | <code>let</code> | No       | <code>string</code>                                               | <code>undefined</code>         | Specify the text displayed next to the icon.<br />Alternatively, use the named slot "textChildren".<br />@example `svelte <br /><br />&lt;HeaderAction&gt;<br />  &lt;div slot="textChildren"&gt;Custom Text&lt;/div&gt;<br />&lt;/HeaderAction&gt;<br />` |
| iconDescription            | No       | <code>let</code> | No       | <code>string</code>                                               | <code>undefined</code>         | Specify an icon tooltip. The tooltip will not be displayed<br />if either the `text` prop or a named slot="textChildren" is used.                                                                                                                          |
...
| loadImage | No       | <code>const</code> | No       | <code>(url?: string) => void</code>                                                                             | --                     | Method invoked to load the image provided a `src` value.<br />If no URL is provided, uses the component's `src` prop.<br />@example `svelte <br /><br />&lt;ImageLoader bind:this={loader} src="default.jpg" /&gt;<br />&lt;button on:click={() =&gt; loader.loadImage("new-image.jpg")}&gt;<br />  Load New Image<br />&lt;/button&gt;<br />` |
...
| Prop name              | Required | Kind             | Reactive | Type                                                                                                           | Default value                     | Description                                                             |
| :--------------------- | :------- | :--------------- | :------- | -------------------------------------------------------------------------------------------------------------- | --------------------------------- | ----------------------------------------------------------------------- |
| open                   | No       | <code>let</code> | Yes      | <code>boolean</code>                                                                                           | <code>true</code>                 | Set to `true` to show the notification, `false` to hide it.             |
...
| clearItem | No       | <code>function</code> | No       | <code>() => void</code> | --                               | Remove the persisted key value from the browser's local storage<br />@example `svelte <br /><br />&lt;LocalStorage bind:this={storage} key="my-key" bind:value={data} /&gt;<br />&lt;button on:click={() =&gt; storage.clearItem()}&gt;Clear Item&lt;/button&gt;<br />` |
| clearAll  | No       | <code>function</code> | No       | <code>() => void</code> | --                               | Clear all key values from the browser's local storage<br />@example `svelte <br /><br />&lt;LocalStorage bind:this={storage} key="my-key" bind:value={data} /&gt;<br />&lt;button on:click={() =&gt; storage.clearAll()}&gt;Clear All Storage&lt;/button&gt;<br />`     |
...
| add              | No       | <code>function</code> | No       | <code>(notification: NotificationData) => string</code> | --                       | Add a notification to the queue.<br />If a notification with the same id exists, the call is ignored.<br />Returns the notification id (either the provided id or a generated one). |
| remove           | No       | <code>function</code> | No       | <code>(id: string) => boolean</code>                    | --                       | Remove a notification by id.<br />Returns true if the notification was found and removed, false otherwise.                                                                          |
...
| text         | No       | <code>let</code> | No       | <code>string</code>                                                 | <code>"Provide text"</code>                        | Specify the item text.<br />Alternatively, use the default slot.<br />@example `svelte <br /><br />&lt;OverflowMenuItem&gt;<br />  &lt;span&gt;Custom Text&lt;/span&gt;<br />&lt;/OverflowMenuItem&gt;<br />` |
...
| legendText    | No       | <code>let</code> | No       | <code>string</code>                         | <code>""</code>           | Specify the legend text.<br />Alternatively, use the named slot "legendChildren".<br />@example `svelte <br /><br />&lt;RadioButtonGroup&gt;<br />  &lt;span slot="legendChildren"&gt;Custom Legend&lt;/span&gt;<br />  &lt;RadioButton labelText="Option 1" value="1" /&gt;<br />  &lt;RadioButton labelText="Option 2" value="2" /&gt;<br />  &lt;RadioButton labelText="Option 3" value="3" /&gt;<br />&lt;/RadioButtonGroup&gt;<br />` |
...
| Prop name     | Required | Kind             | Reactive | Type                 | Default value      | Description                                                                                                                                                                                                                                          |
| :------------ | :------- | :--------------- | :------- | -------------------- | ------------------ | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| as            | No       | <code>let</code> | No       | <code>boolean</code> | <code>false</code> | Set to `true` to render a custom HTML element.<br />Props are destructured as `props` in the default slot.<br />@example `svelte <br /><br />&lt;Row let:props&gt;<br />  &lt;section {...props}&gt;Content&lt;/section&gt;<br />&lt;/Row&gt;<br />` |
| condensed     | No       | <code>let</code> | No       | <code>boolean</code> | <code>false</code> | Set to `true` to use the condensed variant                                                                                                                                                                                                           |
| narrow        | No       | <code>let</code> | No       | <code>boolean</code> | <code>false</code> | Set to `true` to use the narrow variant                                                                                                                                                                                                              |
| noGutter      | No       | <code>let</code> | No       | <code>boolean</code> | <code>false</code> | Set to `true` to remove the gutter                                                                                                                                                                                                                   |
| noGutterLeft  | No       | <code>let</code> | No       | <code>boolean</code> | <code>false</code> | Set to `true` to remove the left gutter                                                                                                                                                                                                              |
...
| legendText | No       | <code>let</code> | No       | <code>string</code>                  | <code>""</code>        | Specify the legend text.<br />Alternatively, use the named slot "legendChildren".<br />@example `svelte <br /><br />&lt;SelectableTileGroup&gt;<br />  &lt;span slot="legendChildren"&gt;Custom Legend&lt;/span&gt;<br />&lt;/SelectableTileGroup&gt;<br />` |
...
| warn           | No       | <code>let</code> | No       | <code>boolean</code>                    | <code>false</code>                                 | Set to `true` to indicate a warning state                                                                                                                                                                                |
| warnText       | No       | <code>let</code> | No       | <code>string</code>                     | <code>""</code>                                    | Specify the warning state text                                                                                                                                                                                           |
| labelText      | No       | <code>let</code> | No       | <code>string</code>                     | <code>""</code>                                    | Specify the label text.<br />Alternatively, use the "labelChildren" slot.<br />@example `svelte <br /><br />&lt;Slider&gt;<br />  &lt;span slot="labelChildren"&gt;Custom Label&lt;/span&gt;<br />&lt;/Slider&gt;<br />` |
| hideLabel      | No       | <code>let</code> | No       | <code>boolean</code>                    | <code>false</code>                                 | Set to `true` to visually hide the label text                                                                                                                                                                            |
...
| align       | No       | <code>let</code> | No       | <code>"start" &#124; "center" &#124; "end" &#124; "stretch" &#124; "baseline"</code>                                 | <code>"stretch"</code>  | Specify the cross-axis alignment of items in the stack.                                                                                                                                                                                   |
| justify     | No       | <code>let</code> | No       | <code>"start" &#124; "center" &#124; "end" &#124; "space-between" &#124; "space-around" &#124; "space-evenly"</code> | <code>"start"</code>    | Specify the main-axis alignment of items in the stack.                                                                                                                                                                                    |
| tag         | No       | <code>let</code> | No       | <code>keyof HTMLElementTagNameMap</code>                                                                             | <code>"div"</code>      | Specify the tag name.                                                                                                                                                                                                                     |
...
| text      | No       | <code>let</code> | No       | <code>string</code>                        | <code>"Provide text"</code>                        | Specify the switch text.<br />Alternatively, use the default slot.<br />@example `svelte <br /><br />&lt;Switch&gt;<br />  &lt;span&gt;Custom Text&lt;/span&gt;<br />&lt;/Switch&gt;<br />` |
...
| label     | No       | <code>let</code> | No       | <code>string</code>                        | <code>""</code>                                    | Specify the tab label.<br />Alternatively, use the default slot.<br />@example `svelte <br /><br />&lt;Tab&gt;<br />  &lt;span&gt;Label&lt;/span&gt;<br />&lt;/Tab&gt;<br />` |
| href      | No       | <code>let</code> | No       | <code>string</code>                        | <code>"#"</code>                                   | Specify the href attribute                                                                                                                                                    |
...
| required   | No       | <code>let</code> | No       | <code>boolean</code>            | <code>undefined</code> | Set to `true` to require the selection of a radio button.                                                                                                                                                                                |
| name       | No       | <code>let</code> | No       | <code>string</code>             | <code>undefined</code> | Specify a name attribute for the radio button inputs.                                                                                                                                                                                    |
| legendText | No       | <code>let</code> | No       | <code>string</code>             | <code>""</code>        | Specify the legend text.<br />Alternatively, use the named slot "legendChildren".<br />@example `svelte <br /><br />&lt;TileGroup&gt;<br />  &lt;span slot="legendChildren"&gt;Custom Legend&lt;/span&gt;<br />&lt;/TileGroup&gt;<br />` |
...
| labelText     | No       | <code>let</code>      | No       | <code>string</code>                                              | <code>""</code>        | Specify the label text                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
| hideLabel     | No       | <code>let</code>      | No       | <code>boolean</code>                                             | <code>false</code>     | Set to `true` to visually hide the label text                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
| expandAll     | No       | <code>function</code> | No       | <code>() => void</code>                                          | --                     | Programmatically expand all nodes<br />@example `svelte <br /><br />&lt;TreeView bind:this={treeView} {nodes} /&gt;<br />&lt;button on:click={() =&gt; treeView.expandAll()}&gt;Expand All&lt;/button&gt;<br />`                                                                                                                                                                                                                                                                                                                                 |
| collapseAll   | No       | <code>function</code> | No       | <code>() => void</code>                                          | --                     | Programmatically collapse all nodes<br />@example `svelte <br /><br />&lt;TreeView bind:this={treeView} {nodes} /&gt;<br />&lt;button on:click={() =&gt; treeView.collapseAll()}&gt;Collapse All&lt;/button&gt;<br />`                                                                                                                                                                                                                                                                                                                           |
| expandNodes   | No       | <code>function</code> | No       | <code>(filterNode?: (node: Node) => boolean) => void</code>      | --                     | Programmatically expand a subset of nodes.<br />Expands all nodes if no argument is provided.<br />Filter function should return `true` for nodes to expand. If not provided, expands all nodes.<br />@example `svelte <br /><br />&lt;TreeView bind:this={treeView} {nodes} /&gt;<br />&lt;button on:click={() =&gt; treeView.expandNodes((node) =&gt; node.id.startsWith('folder-'))}&gt;<br />  Expand Folders<br />&lt;/button&gt;<br />`                                                                                                    |
| collapseNodes | No       | <code>function</code> | No       | <code>(filterNode?: (node: Node) => boolean) => void</code>      | --                     | Programmatically collapse a subset of nodes.<br />Collapses all nodes if no argument is provided.<br />Filter function should return `true` for nodes to collapse. If not provided, collapses all nodes.<br />@example `svelte <br /><br />&lt;TreeView bind:this={treeView} {nodes} /&gt;<br />&lt;button on:click={() =&gt; treeView.collapseNodes((node) =&gt; node.id.startsWith('folder-'))}&gt;<br />  Collapse Folders<br />&lt;/button&gt;<br />`                                                                                        |
| showNode      | No       | <code>function</code> | No       | <code>(id: TreeNodeId, options?: ShowNodeOptions) => void</code> | --                     | Programmatically show a node by `id`.<br />By default, the matching node will be expanded, selected, and focused.<br />Use the options parameter to customize this behavior.<br />@example `svelte <br /><br />&lt;TreeView bind:this={treeView} {nodes} /&gt;<br />&lt;button on:click={() =&gt; treeView.showNode('node-123')}&gt;<br />  Show Node<br />&lt;/button&gt;<br />&lt;button on:click={() =&gt; treeView.showNode('node-123', { expand: false, focus: false })}&gt;<br />  Show Node (No Expand/Focus)<br />&lt;/button&gt;<br />` |
