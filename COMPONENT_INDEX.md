...
| Prop name  | Required | Kind             | Reactive | Type                                                         | Default value                                    | Description                                                                    |
| :--------- | :------- | :--------------- | :------- | ------------------------------------------------------------ | ------------------------------------------------ | ------------------------------------------------------------------------------ |
| level      | No       | <code>let</code> | Yes      | <code>0 &#124; 1 &#124; 2 </code>                            | <code>undefined</code>                           | Specify the layer level and override any existing levels based on hierarchy.   |
| as         | No       | <code>let</code> | No       | <code>typeof import("svelte").SvelteComponent</code>         | <code>"div"</code>                               | Specify the HTML element to render. If none is specified, a `div` is rendered. |
...
| id         | No       | <code>let</code> | No       | <code>string</code>                                          | <code>"ccs-" + Math.random().toString(36)</code> | Set an id for the Layer component                                              |
