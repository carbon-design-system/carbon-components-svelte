...
| clear                    | No       | <code>function</code> | No       | <code>(options?: { focus?: boolean; }) => Promise<void></code>                                        | --                                               | Clear the combo box programmatically<br />@example <br />`svelte<br />&lt;ComboBox bind:this={comboBox} items={items} /&gt;<br />&lt;button on:click={() =&gt; comboBox.clear()}&gt;Clear&lt;/button&gt;<br />&lt;button on:click={() =&gt; comboBox.clear({ focus: false })}&gt;Clear (No Focus)&lt;/button&gt;<br />` |
