  ...
  <DocSection>
    <Grid>
      <!--   <DocSectionHeader
        ...
        title="Get running in three steps"
        description="The shortest route from an empty project to an accessible, themed component."
      />
 -->
      <DocSplitRow
        variant="step"
        ...
        description="Use your package manager of choice."
      >
      ...
      <DocSplitRow
        variant="step"
        step="02"
        title="Apply a theme stylesheet"
        description="Import one precompiled Carbon theme."
      >
        <svelte:fragment slot="right">
          <Stack gap={5}>
            ...
            <Text type="caption-01" color="secondary">
              Import this only once, at the top-level entry point of your app,
              for example index.js or src/+layout.svelte.
            </Text>
          </Stack>
        </svelte:fragment>
      </DocSplitRow>
      ...
      <DocSplitRow
        ...
        description="Add a component to your app."
      >
        <svelte:fragment slot="right">
          <DocCodeBox>
      ...
      <DocSplitRow variant="step" fullWidth rightColumnClass="">
        <svelte:fragment slot="right">
          <Text type="body-long-02" color="secondary" maxWidth="60ch">
            That's a working, accessible app. Browse the
            <Link inline size="lg" href="/component-index">
              component index
            </Link>
            to see every component, or keep reading to fine-tune theming and
            production builds.
          </Text>
        </svelte:fragment>
      </DocSplitRow>
  ...
  <DocSection>
    <Grid>
      <DocSectionHeader
        ...
        description="The icon and pictogram sets ship as separate packages of individual Svelte components. Both are professionally designed, original iconography crafted to complement the scale and grid of Carbon components. Each is optional and independent of carbon-components-svelte, so install only what you need."
      />
...
<style>
  ...
  .usage-snippet :global(.doc-code-box) {
    flex: 1;
    min-height: 17.5rem;
  }

  .usage-snippet :global(.code-override .bx--snippet-container) {
    min-height: 14rem;
    max-height: none !important;
  }

  .usage-snippet :global(.code-override .bx--snippet-container pre) {
    overflow-x: hidden;
