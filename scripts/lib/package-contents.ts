...
/**
 * Release builds unpack to ~6.7 MB on 0.110.x (0.110.2 minus the cache). The
 * budget leaves room for real source growth while still tripping on an
 * artifact the size of the parse cache.
 */
export const UNPACKED_SIZE_BUDGET = 7_200_000;
