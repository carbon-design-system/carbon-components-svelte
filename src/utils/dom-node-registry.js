 ...
 * unregister. Registrations made within the same microtask (e.g. every
 * child of a list registering itself from its own script body during one
 * synchronous mount pass) are batched into a single store flush.
 *
 * @returns {{
