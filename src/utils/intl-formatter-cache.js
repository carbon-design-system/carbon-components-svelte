...
/**
 * Get a cached `Intl.NumberFormat` for the given locale and options,
 * constructing and storing one on a cache miss. Shared across
 * components so that identical locale/options combinations reuse a
 * single formatter instance instead of each component (or each of its
 * instances) building its own.
 *
 * @param {string | undefined} locale
