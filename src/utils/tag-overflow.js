 ...
 * measured widths in order and the space available. Backtracks by one
 * tag at a time if the overflow trigger itself doesn't fit once at
 * least one tag is hidden.
 *
 * @param {Object} options
 * @param {number[]} options.tagWidths - measured width of each tag, in
 *   order
 * @param {number} options.availableWidth
 * @param {number} options.overflowWidth - measured width of the "+N"
 *   trigger
 * @param {number} [options.maxVisible] - upper bound independent of
 *   space
