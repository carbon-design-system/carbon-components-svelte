...
describe("NumberInput", () => {
  ...
  describe("decimal separator normalization", () => {
    test.each([
      ...
      // Edge: comma as decimal only (1,000 → 1.000 → 1)
      ["1,000", 1, "comma as decimal (1.000)"],
      // Invalid input
      ["abc", null, "invalid input"],
      // Multiple separators: last valid value (1.2) preserved before invalid "1.2.3"
      ["1,2,3", 1.2, "multiple commas preserves last valid"],
      [
        "1\u066B2\u066B3",
        1.2,
        "multiple Arabic separators preserves last valid",
      ],
