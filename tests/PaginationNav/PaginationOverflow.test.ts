...
describe("PaginationOverflow", () => {
  it("single-item branch dispatches a 1-based index matching the rendered page", async () => {
  ...
  it("multi-item branch already dispatches a 1-based index for comparison", async () => {
    const onSelect = vi.fn();
    render(PaginationOverflow, {
