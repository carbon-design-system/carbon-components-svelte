...
describe("formatFileSize", () => {
  ...
  it("promotes to the next unit when rounding reaches the base", () => {
  ...
  it("formats the number with a locale", () => {
