...
describe("fuzzyMatch", () => {
  ...
  it("highlights a contiguous prefix substring", () => {
  ...
  it("highlights a mid-string substring as one contiguous run", () => {
  ...
  it("returns no match when query is longer than the text", () => {
  ...
  describe("options", () => {
    it("score is normalized between 0 and 1", () => {
    ...
    it("threshold filters out weaker matches", () => {
    ...
    it("a high threshold requires a prefix", () => {
    ...
    it("caseSensitive only matches the exact case", () => {
...
describe("highlightSegments", () => {
  ...
  it("splits a prefix match into matched then unmatched runs", () => {
  ...
  it("splits a mid-string match into three runs", () => {
  ...
  it("recombines to the original text", () => {
